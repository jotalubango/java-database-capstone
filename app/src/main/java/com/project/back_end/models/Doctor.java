...
public class Doctor {
    ...
    @Size(min = 3, max = 100, message = "Doctor's name must be at least 3 and at most most 100, characters long")
    private String name;
    ...
    @Size(min = 3, max = 50, message = "Doctor's specialty must be at least 3 and at most most 50 characters long")
