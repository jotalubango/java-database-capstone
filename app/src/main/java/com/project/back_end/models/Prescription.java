...
public class Prescription {
     ...
     */
    @NotNull(message = "The ID of the associated appointment cannot be null")
     ...
     */
    @NotNull(message = "The medication prescribed to the patient cannot be null")
    @Size(min = 3, max = 100)
     ...
     */
    @NotNull(message = "Prescription's dosage cannot be null ")
